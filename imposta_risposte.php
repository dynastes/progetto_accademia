  ...
  <body>
    <div class="container text-center">
        <h1 class="text-center"> Imoposta risposte</h1>
            ...
            <h3> <?php session_start(); echo($_SESSION['nome_questionario']);  $domanda_corrente = $_GET['domanda_corrente'];?></h3>
            <br />
            <p>
      ...
      <div>
        <div>
            <form action="setta_variabili_nome_risposte.php?domanda_corrente=<?php echo($domanda_corrente); ?>" method="post">
              <?php
