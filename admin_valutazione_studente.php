...
<body>
<?php menu(); ?>
<div class="container" id="container_voti">
    <div class="page-header">
        <h1>Aggiungi i voti allo studente</h1>
    ...
    <?php } else {
        ...
        $sql_corsoStudente="SELECT Id_corso FROM studenti WHERE Id_anagrafe=".$id;
            ...
            <div class="row">
                <div class="form-group">
                    <table class="table table-curved">
                        ...
                        <tr>
                            <th class="title" colspan="10" style="text-align:center">
                        ...
                        <tr>
                            <th class="title" colspan="10" style="text-align:center">Piano di Studi Consigliato</th>
                        </tr>
                        ...
                        for ($i = 1; $i <= $anni; ++$i) {
                            ...
                            ?>
                            <tr>
                                <th colspan="10" style="background-color:#0393FC; color:white; text-align:center;">
                                    ANNO <?php echo $i; ?></th>
                            </tr>
...
//echo "num:".$rowspan_base;
                            while ($res = $res_piani->fetch_assoc()) {
                                ...
                                $sql_carica_materia_e_settore = "SELECT Nome_materia, Id_settore,Id FROM materie_anagrafica WHERE Id='" . $id_materia . "'";
