...
<body>
	...
	<!-- start slider -->
						...
						<div class="row form-group">
							...
							<input type="password" name="password" class="form-control" placeholder="inserisci nuova password qui" required>
						</div> <!-- /row form-group (1) -->		
						
						<div class="row form-group">
							<label>Conferma nuova password:</label>
							<input type="password" name="password" class="form-control" placeholder="conferma nuova password qui" required>
						</div> <!-- /row form-group (1) -->
