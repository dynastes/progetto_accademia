...
try {
    ...
    $mail->addReplyTo('support@accademiakandi.it', 'Per supporto');
	...
	Questa è la password provvisoria che potrai cambiare al momento del nuovo accesso:<br /><br /> <b>'.$uncripted_pass.'</b> <br /><br />
    ...
    $mail->Subject = 'Ripristino password ABAK';
    $mail->Body    = $body;
